...
function updateBulletsVisibility() {
...
window.addEventListener("resize", updateBulletsVisibility);
window.addEventListener("load", updateBulletsVisibility);

bulletsSpan.forEach((span) => {
  span.addEventListener("click", (e) => {
    if (window.innerWidth > 575) {
      // Only allow changes if screen width is greater than 575px
